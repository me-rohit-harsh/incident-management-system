...
public class DashController {
	...
	public String showDashboard(HttpSession session, Model model, @RequestParam Optional<String> incidentId) {
	...
	public String showEditIncidentForm(@PathVariable String id, HttpSession session, Model model,
	...
	public String updateIncident(@ModelAttribute("incident") Incident incident, RedirectAttributes redirectAttributes,
		...
		if (existingIncident != null) {
			...
			String status = existingIncident.getDetails();
			List<Incident> incidentsWith = incidentRepository.findByDetails(status);
    ...
    public ResponseEntity<?> fetchIncidentDetails(@RequestParam("details") String details) {
        List<Incident> incidents = incidentRepository.findByDetails(details);
